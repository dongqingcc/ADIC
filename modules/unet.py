...
class Unet(nn.Module):
    def __init__(
        ...
        with_time_emb=True,
        embd_type="01",
        # ===== [新增] 控制 mid block 是否用 full attention =====
        ...
        # ===== [优化] Mid block 用 Full Attention =====
        # Bottleneck 分辨率最小，计算量不大但全局感受野很重要
        if use_full_attn_mid:
    ...
    def forward(self, x, time=None, context=None, contro=None):
